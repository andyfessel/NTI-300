...
# please choose a nme other than test3
...
project = 'planar-berm-254901'
zone = 'us-central1-a'
name = 'hackmanhelpedme'
...
source_disk_imate = image_response['selfLink']
...
new instances = create_instance(compute, project, zone, name)
